...
export const nodes: GraphNode[] = [
  ...
  { id: 'group-all-staff', type: 'group', label: 'Alle Personeelsleden' },
  ...
  // ── ADDITIONAL DOCUMENTS (visual density — realistic enterprise file spread) ──

  // HR salary library — more files behind the EEEU breach
  ...
  // Intranet documents (accessible to everyone via EEEU)
...
export const edges: GraphEdge[] = [
  ...
  // ── ADDITIONAL LIBRARY → DOCUMENT edges (for new documents) ─────────────

  // HR salary library docs
  ...
  // Onderwijs projecten library docs
  ...
  // Strategische nota library docs
  ...
  // AWV infrastructure library docs
  ...
  // Lokale Besturen site docs (via lokale-besturen group)
  ...
  // Intranet docs (reachable via EEEU all-staff → site-intranet)
